...
public interface IPrenatalVisitService
{
    ...
    Task<PagedResult<PrenatalVisitDto>> GetByPregnancyIdPagedAsync(Guid pregnancyId, Guid userId, QueryOptions options, CancellationToken cancellationToken = default);
